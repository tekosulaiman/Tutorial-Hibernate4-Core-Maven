 ...
 */
public class FormHqlWhereClause extends javax.swing.JInternalFrame {
    ...
    public FormHqlWhereClause() {
        this.visible = false;

        employeeTableModel.setList(employeeService.getWhereClauseEmployees());
        System.out.println("Select Clause >>> "+employeeService.getWhereClauseEmployees());
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Form Hql Where Clause");
